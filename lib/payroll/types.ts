...
export type PayrollLine = {
  ...
  gross: number;
  /**
   * เงินได้พึงประเมินของงวดนี้ = ค่าจ้างฐาน + เฉพาะรายการที่ติดธง `taxable`
   *
   * 🚨 ต้อง **แช่ไว้ใน `payroll_items.computed`** เพราะ ภงด.1 / ภงด.1ก / 50ทวิ ใช้ยอดนี้
   *    ถ้าไปไล่อ่านธง `taxable` สดจาก config ตอนออกเอกสาร → ลูกค้าแก้ธงกลางปีเมื่อไหร่
   *    ตัวเลขที่ยื่นราชการไปแล้วจะเปลี่ยนย้อนหลังเงียบ ๆ (กับดักเดียวกับ D66 ข้อ 2)
   * ★ ไม่เท่ากับ `gross` เมื่อมีรายการที่ไม่ติดธงภาษี (เช่นเงินชดเชยค่าเดินทาง)
   */
