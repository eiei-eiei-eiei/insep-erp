/**
 * lib/shared/taxCustomer — กติกาการกรอกข้อมูลคู่ค้าตอนเพิ่มลูกค้าใหม่ (D86)
 *
 * ★ ย้ายมาจาก `lib/sales/customer.ts` ใน D96 (ไฟล์เดิมเหลือแค่ re-export)
 *   เพราะโมดูลบาร์ต้องใช้กฎชุดเดียวกันตอนออกใบกำกับให้ลูกค้าที่ขอในนามบริษัท
 *   แต่ `lib/bar` ห้าม import `lib/sales` (กติกา D92 — lib ห้ามข้ามโดเมนกัน)
 *   ⇒ **ตัวเนื้อไม่ถูกแก้แม้บรรทัดเดียว** golden S13 จึงผ่านโดยไม่แก้ไฟล์เทส
 *
