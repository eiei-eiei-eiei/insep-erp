...
## D95 — "ยื่นแล้ว" แยกจาก "กดพิมพ์แล้ว" + วิธียื่นแบบภาษี (migration 0063)

### ① ต้องทำก่อนใช้

| สิ่งที่ต้องทำ | ที่ไหน | ถ้าไม่ทำจะเป็นยังไง |
|---|---|---|
| ลง migration **0063** ทุก DB | `npm run db:push:all -- --apply` | แท็บเอกสารสรรพากรเปิดไม่ได้ (ตาราง `tax_filings` ยังไม่มี) |
