...
### D95 — "ยื่นแล้ว" เป็นเหตุการณ์ของตัวเอง + 3 จังหวะเตือน + วิธียื่นของกิจการ (0063, 2026-09-12)
...
→ สคริปต์ `gen-0063.mjs` เปลี่ยนไป**ค้นหาไฟล์ล่าสุดที่นิยามฟังก์ชันเอง** และอ่าน dollar-quote tag
...
**ไฟล์**: migration **0063** (สร้างด้วย `node scripts/gen/gen-0063.mjs` · header ที่
`scripts/gen/0063-header.sql`) · `lib/accounting/taxFiling.ts` + `.test.ts` (golden **A20** 35) ·
...
build/lint/test **1058** ผ่าน · ชุดเทส `docs/TESTING.md` ส่วนที่ **52**
