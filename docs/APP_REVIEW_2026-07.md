...
สิ่งที่ทำดีอยู่แล้ว (ไม่ต้องแตะ): draft ค้างใน localStorage (`EntryTab.tsx:97-135`), บิลล่าสุดของคู่ค้า (`EntryTab.tsx:151-172`), สแกน AI *(หมายเหตุ 2026-08-18: ตัดฟีเจอร์นี้ทิ้งแล้ว — D61)*, ดรอปดาวน์จากประวัติ, คงคู่ค้า/หมวดหลังบันทึก (`EntryTab.tsx:271`) — D35 ทำงานได้จริง
