...
export default async function AppLayout({
  ...
  // ── ระงับการใช้งาน (0037) ──────────────────────────────────────────────────
  //
  // 🚨 **ต้องเช็คก่อน `must_change_password` เสมอ** — สลับลำดับเมื่อไหร่ ลูกค้าที่ถูก
  //    ระงับเพราะค้างค่างวดและเพิ่งถูกรีเซ็ตรหัส จะถูกบังคับให้คิดรหัสใหม่ กรอก 2 ช่อง
  //    กดบันทึก **แล้วค่อยรู้ว่าเข้าใช้งานไม่ได้อยู่ดี** = ให้ผู้ใช้ทำงานฟรีก่อนบอกความจริง
  //    (เจ้าของกิจการชี้เองตอนเทส 2026-09-06: เส้นทางจริงคือ ล็อกอิน → เห็นว่าถูกระงับ →
  //     ติดต่อผู้ดูแล → จ่ายเงิน → ปลดล็อก · ไม่มีจังหวะไหนที่ต้องตั้งรหัสใหม่เลย)
  //    ★ ลำดับนี้มีเทสล็อกไว้ที่ `lib/shared/suspendOrder.test.ts`
  //
