/**
 * สร้าง migration 0071 (D95) โดย **ยก plpgsql เดิมมาทั้งดุ้น** แล้วแทรกเฉพาะบรรทัดที่ตั้งใจ
 ...
 *
 * รัน:  node scripts/gen/gen-0071.mjs
 */
import fs from "node:fs";
import path from "node:path";

const OUT_NAME = "20260914000071_tax_filings.sql";
...
const HEADER = "scripts/gen/0071-header.sql";
